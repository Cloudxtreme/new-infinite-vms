...
sed -i 's/TCP_IN = "20,21,22,25,53,80,110,143,443,465,587,993,995,2221"/TCP_IN = "53,2086,2087,2222"/g' /etc/csf/csf.conf
sed -i 's/TCP_IN = "20,21,22,25,53,80,110,143,443,465,587,993,995,2077,2078,2079,2080,2082,2083,2086,2087,2095,2096,2222"/TCP_IN = "53,2086,2087,2222"/g' /etc/csf/csf.conf
sed -i 's/TCP_OUT = "20,21,22,25,37,53,80,110,113,443,587,993,995"/TCP_OUT = "37,53,443"/g' /etc/csf/csf.conf
sed -i 's/TCP_OUT = "20,21,22,25,37,43,53,80,110,113,443,587,873,993,995,2086,2087,2089,2703"/TCP_OUT = "37,53,443"/g' /etc/csf/csf.conf
sed -i 's/UDP_IN = "20,21,53"/UDP_IN = "53"/g' /etc/csf/csf.conf
sed -i 's/UDP_OUT = "20,21,53,113,123"/UDP_OUT = "53"/g' /etc/csf/csf.conf
sed -i 's/UDP_OUT = "20,21,53,113,123,873,6277,24441"/UDP_OUT = "53"/g' /etc/csf/csf.conf
