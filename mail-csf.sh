...
sed -i 's/TCP_IN = "20,21,22,25,53,80,110,143,443,465,587,993,995,2077,2078,2079,2080,2082,2083,2086,2087,2095,2096"/TCP_IN = "25,26,465,587,993,995,2083,2087,2095,2096,2222,24441"/g' /etc/csf/csf.conf
