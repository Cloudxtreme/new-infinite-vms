...
sed -i 's/TCP_OUT = "20,21,22,25,37,53,80,110,113,443,587,993,995"/TCP_OUT = "37,80,443,465,587,2525"/g' /etc/csf/csf.conf
...
sed -i 's/UDP_OUT = "20,21,53,113,123"/UDP_OUT = "37,80,443,465,587,2525"/g' /etc/csf/csf.conf
